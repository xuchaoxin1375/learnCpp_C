//program 19.2.2.1.cpp list示例程序
#include <list>  //使用list需要包含此头文件
#include <iostream>
...
int main()   
{
	...
	cout << "7) "; Print(lst1.begin(),lst1.end());//输出7) 40 30 30 20 4 3 1
	lst2.insert(lst2.begin(),a+1,a+4); //lst2 插入 3,2,4 三个元素 
